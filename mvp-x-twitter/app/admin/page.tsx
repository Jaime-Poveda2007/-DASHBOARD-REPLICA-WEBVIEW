...
export default function AdminPage() {
  ...
  useEffect(() => {
    const verificarAdmin = async () => {
      ...
      // Cambia este email por el tuyo (Kevin)
      if (data.user.email !== 'kevingabrielgonzalez1234@gmail.com') {
        router.push('/feed');
        return;
      }
      fetchTweets();
                  ...
                  <div key={tweet.id} style={{ padding: '16px 24px', borderBottom: '1px solid #2f3336', display: 'flex', gap: 12 }}>
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
                        <span style={{ color: '#71767b', fontSize: 13 }}>❤️ {tweet.likes_count || 0}</span>
                        <span style={{ color: '#71767b', fontSize: 13 }}>🔁 {tweet.retweets_count || 0}</span>
                        <button
